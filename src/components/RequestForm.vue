<template>
  <div class="request-form">
    <div class="request-form__content">
      ...
      >
        <fieldset class="request-form__fieldset">
      ...
      <footer class="request-form__footer">
        <button
          type="submit"
          form="requestForm"
          value="Request Info"
...
<style lang="scss">
  .request-form {
    ...
    &__select {
      ...
      &-container {
        ...
        &::after {
          ...
          width: .625em;
          height: .625em;
          border: 3px solid $su-medium-gray;
          border-top: none;
          border-right: none;
          border-radius: 2px;
          z-index: 3;
    ...
    &__button {
      border: none;
      background-color: $su-dark-orange;
      color: $white;
      @include flex-row;
